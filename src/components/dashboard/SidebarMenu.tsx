...
const allMenuItems = [
  ...
  { icon: Icons.Award, label: "Recognition", path: "/recognition", roles: ["hr", "employee"] },
  { icon: Icons.MessageSquare, label: "Internal Chat", path: "/internal-chat", roles: ["hr", "employee"] },
  { icon: Icons.TrendingUp, label: "Career Growth", path: "/career-growth", roles: ["hr", "employee"] },
  { icon: Icons.BrainCircuit, label: "Resume Screening", path: "/resume-screening", roles: ["hr", "admin"] },
